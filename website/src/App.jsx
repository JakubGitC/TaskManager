...
import { TopMenu, Menu } from "./components";
...
function Layout() {
  ...
  return user ? (
    <div className="w-full h-screen flex flex-col md:flex-row bg-white">
      <div className="w-1/6 h-screen bg-white dark:bg-[#1f1f1f] sticky top-0 hidden md:block">
        <Menu />
      </div>
    ...
    <>
      ...
      >
        {(ref) => (
          ...
          >
            <div className="bg-custom-color1 w-full h-full">
